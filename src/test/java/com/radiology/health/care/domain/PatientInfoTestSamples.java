...
public class PatientInfoTestSamples {
    ...
    public static PatientInfo getPatientInfoSample1() {
        return new PatientInfo().id(1L).name("name1").age(1).gender("gender1").dateOfBirth("dateOfBirth1").mobile(1L).relation("relation1");
    }

    public static PatientInfo getPatientInfoSample2() {
        return new PatientInfo().id(2L).name("name2").age(2).gender("gender2").dateOfBirth("dateOfBirth2").mobile(2L).relation("relation2");
    }
