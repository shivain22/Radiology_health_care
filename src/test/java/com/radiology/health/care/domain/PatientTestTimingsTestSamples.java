...
public class PatientTestTimingsTestSamples {
    ...
    public static PatientTestTimings getPatientTestTimingsSample1() {
        return new PatientTestTimings().id(1L).priority("priority1").clinicalNote("clinicalNote1").spclInstruction("spclInstruction1");
    }

    public static PatientTestTimings getPatientTestTimingsSample2() {
        return new PatientTestTimings().id(2L).priority("priority2").clinicalNote("clinicalNote2").spclInstruction("spclInstruction2");
    }
