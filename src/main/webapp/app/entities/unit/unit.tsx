...
import { getEntities, reset } from './unit.reducer';
...
export const Unit = () => {
  ...
  const links = useAppSelector(state => state.unit.links);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={unitList ? unitList.length : 0}
          next={handleLoadMore}
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button
                          onClick={() => (window.location.href = `/unit/${unit.id}/delete`)}
                          color="danger"
                          size="sm"
