...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFICETIMINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_OFFICETIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OFFICETIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OFFICETIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OFFICETIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OFFICETIMINGS actions', async () => {
      const expectedActions = [
        {
