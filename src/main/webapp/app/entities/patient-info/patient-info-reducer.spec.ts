...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATIENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATIENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PATIENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATIENTINFO actions', async () => {
      const expectedActions = [
        {
