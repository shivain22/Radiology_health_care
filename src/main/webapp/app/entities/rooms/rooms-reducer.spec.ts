...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rooms.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOMS actions', async () => {
      const expectedActions = [
        {
