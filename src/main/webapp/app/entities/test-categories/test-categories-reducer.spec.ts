...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCATEGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCATEGORIES actions', async () => {
      const expectedActions = [
        {
