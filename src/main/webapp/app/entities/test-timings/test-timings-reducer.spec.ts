...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTTIMINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTTIMINGS actions', async () => {
      const expectedActions = [
        {
