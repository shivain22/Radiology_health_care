...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './techician-equipment-mapping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TECHICIANEQUIPMENTMAPPING_LIST actions', async () => {
    ...
    it('dispatches FETCH_TECHICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TECHICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TECHICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TECHICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TECHICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
