...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './patient-test-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTTESTINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATIENTTESTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATIENTTESTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PATIENTTESTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTTESTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATIENTTESTINFO actions', async () => {
      const expectedActions = [
        {
