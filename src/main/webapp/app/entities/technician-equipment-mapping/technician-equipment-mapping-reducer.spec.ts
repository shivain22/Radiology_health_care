...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './technician-equipment-mapping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TECHNICIANEQUIPMENTMAPPING_LIST actions', async () => {
    ...
    it('dispatches FETCH_TECHNICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TECHNICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TECHNICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TECHNICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TECHNICIANEQUIPMENTMAPPING actions', async () => {
      const expectedActions = [
        {
