...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EQUIPMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EQUIPMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EQUIPMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EQUIPMENTS actions', async () => {
      const expectedActions = [
        {
