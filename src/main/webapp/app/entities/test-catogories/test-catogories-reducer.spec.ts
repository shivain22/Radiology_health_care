...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCATOGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCATOGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCATOGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCATOGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCATOGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCATOGORIES actions', async () => {
      const expectedActions = [
        {
