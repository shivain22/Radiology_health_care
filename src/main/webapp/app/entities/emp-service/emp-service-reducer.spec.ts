...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPSERVICE actions', async () => {
      const expectedActions = [
        {
