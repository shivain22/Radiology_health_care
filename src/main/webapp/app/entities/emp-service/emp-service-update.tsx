  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="radiologyHealthCareApp.empService.home.createOrEditLabel" data-cy="EmpServiceCreateUpdateHeading">
            Create or edit a Emp Service
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="emp-service-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Name"
                id="emp-service-name"
                name="name"
...
export default EmpServiceUpdate;
