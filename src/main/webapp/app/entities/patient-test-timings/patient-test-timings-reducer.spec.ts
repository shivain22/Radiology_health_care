...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './patient-test-timings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTTESTTIMINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATIENTTESTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATIENTTESTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PATIENTTESTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTTESTTIMINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATIENTTESTTIMINGS actions', async () => {
      const expectedActions = [
        {
