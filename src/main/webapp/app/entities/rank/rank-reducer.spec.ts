...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rank.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RANK_LIST actions', async () => {
    ...
    it('dispatches FETCH_RANK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RANK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RANK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RANK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RANK actions', async () => {
      const expectedActions = [
        {
